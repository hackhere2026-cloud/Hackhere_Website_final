  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        if (!user && !firebaseResolved) return;
        ...
        if (!user && firebaseUser) {
          const firebaseProfile = {
            ...
            updatedAt: firebaseUser.metadata?.lastSignInTime || null,
          ...
          setUserData(firebaseProfile);
          setEditedData(firebaseProfile);
          setUserSkills([]);
          return;
        }
    ...
    fetchUserData();
  }, [user, firebaseUser, firebaseResolved]);
